...
public class KafkaTest {
	...
	/**
	 * Checks that a message can be delivered and received to/from the Kafka broker.
	 * Expects the message to be received within a reasonable time ({@link Duration#TEN_SECONDS})
	 */
	@Test
